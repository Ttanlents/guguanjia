...
public class FTPUtil {
    ...
    public static void main(String[] args) {
        ...
        FTPClient ftp = test.getFTPClient("192.168.1.116", 21, "user","user");
        //test.downLoadFTP(ftp, "/file", "你好.jpg", "C:\\下载")192.168.226.1;
        //test.copyFile(ftp, "/file", "/txt/temp", "你好.txt");
        test.uploadFile(ftp, "C:/Users/FT/Pictures/a.png", "/uploads");
